...
class DeepVAREstimator(PyTorchLightningEstimator):
    ...
    def create_transformation(self) -> Transformation:
        ...
        return Chain(
            ...
            + [
                ...
                # comment this first because we don't have a mutlivariate
                # Distribtion class
                # ExpandDimArray(
                #     field=FieldName.TARGET,
        ...
        # Play with keeping remove field names later
    ...
    def _create_instance_splitter(
        ...
        # dummy value is deleted in the mxnet.deepvar code
    ...
    def create_predictor(
        ...
        # Myabe we need to pass target_dim to PyTorchPredictor,
        # But I suspect not. Let's check later
