...
from .module import DeepARModel, MultivariateDeepARModel
from .lightning_module import DeepARLightningModule, MultivariateDeepARLightningModule
...
class MultivariateDeepAREstimator(PyTorchLightningEstimator):
    @validated()
    def __init__(
        self,
        freq: str,
        ...
        self.use_flow_architecture = use_flow_architecture
    ...
    def create_lightning_module(self) -> DeepARLightningModule:
        model = MultivariateDeepARModel(
            ...
            scaling=self.scaling,
            num_parallel_samples=self.num_parallel_samples,
            use_flow_architecture=self.use_flow_architecture,
            threshold_input = self.threshold_input,
            cg_atol = self.cg_atol,
            num_expected = self.num_expected,
        )

        return MultivariateDeepARLightningModule(model=model, loss=self.loss)
